...
var f5BB=_mz(z,'radio-group',['bindupdate:selected',116,'data-event-opts',1,'label',2,'selected',3],[],b1BB,eZBB,gg)
_(o4BB,f5BB)
_(o2BB,o4BB)
return o2BB
}
...
var h7BB=_n('text')
var o8BB=_oz(z,121,e,s,gg)
_(h7BB,o8BB)
_(c6BB,h7BB)
var c9BB=_mz(z,'uni-number-box',['bind:__l',122,'bind:change',1,'data-event-opts',2,'min',3,'value',4,'vueId',5],[],e,s,gg)
_(c6BB,c9BB)
_(lWBB,c6BB)
_(xOBB,lWBB)
var o0BB=_mz(z,'view',['catchtap',128,'class',1,'data-event-opts',2,'style',3],[],e,s,gg)
var lACB=_oz(z,132,e,s,gg)
_(o0BB,lACB)
_(xOBB,o0BB)
_(h90,xOBB)
var aBCB=_mz(z,'bottom-popup',['bind:__l',133,'bind:hide',1,'data-event-opts',2,'popupClass',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var tCCB=_mz(z,'view',['class',139,'style',1],[],e,s,gg)
var eDCB=_oz(z,141,e,s,gg)
_(tCCB,eDCB)
_(aBCB,tCCB)
var bECB=_mz(z,'scroll-view',['scrollY',-1,'class',142,'style',1],[],e,s,gg)
var oFCB=_mz(z,'uni-list-item',['bind:__l',144,'vueId',1,'vueSlots',2],[],e,s,gg)
var xGCB=_n('view')
_rz(z,xGCB,'class',147,e,s,gg)
var oHCB=_oz(z,148,e,s,gg)
_(xGCB,oHCB)
_(oFCB,xGCB)
var fICB=_n('view')
_rz(z,fICB,'class',149,e,s,gg)
var cJCB=_oz(z,150,e,s,gg)
_(fICB,cJCB)
_(oFCB,fICB)
_(bECB,oFCB)
_(aBCB,bECB)
_(h90,aBCB)
var hKCB=_mz(z,'bottom-popup',['bind:__l',151,'bind:hide',1,'data-event-opts',2,'popupClass',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var oLCB=_mz(z,'view',['class',157,'style',1],[],e,s,gg)
var cMCB=_oz(z,159,e,s,gg)
_(oLCB,cMCB)
_(hKCB,oLCB)
var oNCB=_mz(z,'scroll-view',['scrollY',-1,'class',160,'style',1],[],e,s,gg)
var lOCB=_n('view')
_rz(z,lOCB,'class',162,e,s,gg)
var aPCB=_n('view')
_rz(z,aPCB,'class',163,e,s,gg)
var tQCB=_n('view')
_rz(z,tQCB,'class',164,e,s,gg)
_(aPCB,tQCB)
var eRCB=_oz(z,165,e,s,gg)
_(aPCB,eRCB)
_(lOCB,aPCB)
var bSCB=_mz(z,'text',['class',166,'style',1],[],e,s,gg)
var oTCB=_oz(z,168,e,s,gg)
_(bSCB,oTCB)
_(lOCB,bSCB)
_(oNCB,lOCB)
_(hKCB,oNCB)
_(h90,hKCB)
var xUCB=_mz(z,'go-to-up',['bind:__l',169,'bottom',1,'scrollTop',2,'vueId',3],[],e,s,gg)
_(h90,xUCB)
_(r,h90)
return r
}
